...
local OnEvent = function(self, event, ...)
	if event == "START_LOOT_ROLL" then
		...
		--lootFrame:SetStatusBarColor(color.r, color.g, color.b, 0.3) --È¾É«Í¸Ã÷¶È
		if quality == 2 then
		lootFrame:SetStatusBarColor(0.07, 1, 0.6, 0.5) --ÂÌ
		elseif quality == 3 then
		lootFrame:SetStatusBarColor(0.07, 0.74, 1, 0.5) --À¶
		elseif quality == 4 then
		lootFrame:SetStatusBarColor(0.73, 0.45, 0.98, 0.5) --×Ï
		else
