...
function nEF.UpdateSettings()
	...
	nEF.Frames.Main:SetPoint(Opts.position.anchor, PF, Opts.position.anchor, Opts.position.x, Opts.position.y)
...
function nEF.CreateFrames()
	...
	-- Create main frame
	nEF.Frames.Main = CreateFrame("Frame", "nibEclipse", UIParent)
