...
if cfg.Spec == true then
	...
	local function Update(self, t)
		...
		if int < 0 then
			...
			--Text:SetText(cfg.ColorClass and init.Colored..select(2,GetSpecializationInfo(primaryTree,false,false)) or select(2,GetSpecializationInfo(primaryTree,false,false)))
		end
	end
